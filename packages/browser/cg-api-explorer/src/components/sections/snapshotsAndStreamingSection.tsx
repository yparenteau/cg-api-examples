...
import EventTypesControl from "../controls/eventTypesControl";
...
import GetEqual from "../snapshotsAndStreaming/getEqual";
import GetMatch from "../snapshotsAndStreaming/getMatch";
import GetPattern from "../snapshotsAndStreaming/getPattern";
import GetFirstLast from "../snapshotsAndStreaming/getFirstLast";
import GetNextPrevious from "../snapshotsAndStreaming/getNextPrevious";
...
namespace SnapshotsAndStreamingSection {
    // Own props.
    interface OwnProps {}
    ...
    export class ComponentImpl extends React.PureComponent<Props> {
        ...
        render() {
            return (
                <Col>
                    <CollapsibleSection.Component title="Snapshots and Streaming" initialCollapseState={false}>
                                ...
                                <Form onSubmit={this.processSubmit}>
                                    <Tab.Content>
                                        ...
                                        {this.props.activeTab === "getEqual" && (
                                            <Tab.Pane eventKey="getEqual">
                                                <GetEqual.Component symbolList={this.props.symbolList} onChange={this.onChange} />
                                            </Tab.Pane>
                                        )}
                                    ...
                                    <Form.Group as={Form.Row} className="form-group-margin">
                                        ...
                                        <Col sm={inputColumnWidth}>
                                            <SubscriptionTypeControl.Component
                                                size="sm"
...
} // namespace SnapshotsAndStreaming

export default SnapshotsAndStreamingSection;
