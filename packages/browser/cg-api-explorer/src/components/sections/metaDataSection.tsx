...
import GetSubscriptionInfo from "../metaData/getSubscriptionInfo";
import GetPermissionInfo from "../metaData/getPermissionInfo";
import GetTableInfo from "../metaData/getTableInfo";
import GetRelationshipInfo from "../metaData/getRelationshipInfo";
...
namespace MetaDataSection {
    ...
    export class ComponentImpl extends React.PureComponent<Props> {
        render() {
            return (
                <Col>
                    <CollapsibleSection.Component title="Metadata" initialCollapseState={true}>
