...
export namespace SymbolIdListControl {
                        ...
                        <Form.Row className="float-right">
                            <SimpleTooltip text="Add another">
                                <Button
                                    ...
                                    onClick={this.props.addSymbolId}
                                >
                        ...
                        {this.props.symbolIdList.map((symbolId, index) => (
                            ...
                            >
                                <SymbolIdControl.Component
                                    ...
                                    onRemove={
                                        this.props.symbolIdList.length > 1
                                            ? () => this.props.removeSymbolId(symbolId.key)
                                            : undefined
                                    }
                                />
                            </Card>
...
} // namespace SymbolIdListControl

export default SymbolIdListControl;
